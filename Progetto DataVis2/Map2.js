        ...
        const updateCountsForYear = (year) => {
            ...
            .on("mouseover", function (event, d) {
                ...
                tooltip.style("opacity", 1)
                    ...
                    getStateMedalData("Dataset.json", state).then(data => {
...
// Esempio di utilizzo
initializeChoroplethMap("Dataset.json", "https://raw.githubusercontent.com/holtzy/D3-graph-gallery/master/DATA/world.geojson");