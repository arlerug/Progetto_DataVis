var state = "";
var medals;
var tooltips = {}; // Per tenere traccia dei tooltip attivi per nazione
...
function createYearDropdown(sortedYears, updateTreemap, data) {
  ...
  dropdownContainer.style.marginTop = "10px"; // Spazio tra dropdown e il titolo
...
function updateTreemap(year, data) {
  ...
  // Scala dei colori con blu visibile per il valore minimo
  const colorScale = d3
    .scaleSequential()
