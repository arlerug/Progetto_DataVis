...
function initializeWomen(filePath) {
  ...
  graphContainer.style("width", "100vw").style("height", "100vh");
  ...
  fetch(filePath)
    ...
    .then((data) => {
      ...
      function renderChart() {
        ...
        const renderTooltipChart = (disciplines, sex, year) => {
          tooltipHeader.text(`${sex} - ${year}`);
        ...
        gChart
          ...
          .on("mouseover", (event, d) => {
            ...
            renderTooltipChart(d.maleDisciplines, "Male", d.year);
        ...
        gChart
          ...
          .on("mouseover", (event, d) => {
            tooltip.transition().duration(200).style("opacity", 1);
            renderTooltipChart(d.femaleDisciplines, "Female", d.year);
            const tooltipRect = tooltip.node().getBoundingClientRect();
            if (d.year >= 1980) {
              tooltip
                .style("left", `${event.pageX - tooltipRect.width - 10}px`) // Tooltip a sinistra
